...
public class Bouquet {
    ...
    public void remove(Flower flower) {
        ...
        for (int i = 0; i < flowers.size(); i++) {
            if (flag || (flowers.get(i).getLength() != flower.getLength() || flowers.get(i).getWeight() != flower.getWeight() ||
                    flowers.get(i).getPrice() != flower.getPrice() || !flowers.get(i).getName().equals(flower.getName())
